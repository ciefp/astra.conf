...
f3615rtrn0 = make_t2mi_decap({
        name = "3615L PLP1",
        input = "http://127.0.0.1:8001/1:0:1:320:3A2:0:1910E1F:0:0:0:",
        plp = 1,
        pnr = 0,
        pid = 4096,
})
...
make_channel({                                                         
        name = "3615plp1", input = { "t2mi://f3615rtrn0", },           
        output = { "http://0.0.0.0:9999/rtrn/3615plp1", },             
})                                                                     

f3635rtrn0 = make_t2mi_decap({
        name = "3635L PLP1",
        input = "http://127.0.0.1:8001/1:0:1:320:3A2:0:1910E33:0:0:0:",
        plp = 1,
        pnr = 0,
        pid = 4096,
})
...
make_channel({                                                         
        name = "3635plp1", input = { "t2mi://f3635rtrn0", },           
        output = { "http://0.0.0.0:9999/rtrn/3635plp1", },             
})                                                                     
...
f11401dasto0 = make_t2mi_decap({
        name = "11401V PLP0",
        input = "http://127.0.0.1:8001/1:0:1:FA1:190:0:A0AC89:0:0:0:",
        plp = 0,
        pnr = 0,
        pid = 4095,
})
...
f12285krrt800 = make_t2mi_decap({
        name = "Service_800 PLP0",
        input = "http://127.0.0.1:8001/1:0:1:320:C9E:3:EB0000:0:0:0:",
        plp = 0,
        pnr = 0,
        pid = 4096,
})
...
f12285krrt801 = make_t2mi_decap({
        name = "Service_801 PLP0",
        input = "http://127.0.0.1:8001/1:0:1:321:C9E:3:EB0000:0:0:0:",
        plp = 0,
        pnr = 0,
        pid = 4097,
})
...
f12606raimuxb = make_t2mi_decap({
        name = "12606V SID 0x320 MIS5 PLP0",
        input = "http://127.0.0.1:8001/1:0:1:320:2:0:DDEB13E:0:0:0:",
        plp = 0,
        pnr = 0,
        pid = 4096,
})
...
ortmx1 = make_t2mi_decap({
  name = "4014V SID 0x320",
  input = "http://localhost:8001/1:0:1:320:3A2:0:D5B0FAE:0:0:0",
  plp = 0,
  pnr = 0,
  pid = 4096,
})
...
make_channel({
  name = "4014 V SID 0x320",
  input = { "t2mi://ortmx1", },
  output = { "http://0.0.0.0:9999/ortm/x1", },
})

ortmx2 = make_t2mi_decap({
  name = "4095V SID 0x320",
  input = "http://localhost:8001/1:0:1:320:3A2:0:D5B0FFF:0:0:0",
  plp = 0,
  pnr = 0,
  pid = 4096,
})
...
make_channel({
  name = "4095V SID 0x320",
  input = { "t2mi://ortmx2", },
  output = { "http://0.0.0.0:9999/ortm/x2", },
})

-- Dasto Semtel 21.5E

t2mi_dasto_plp0= make_t2mi_decap({
        name = "11403V SID 0x01 PLP0",
        input = "http://127.0.0.1:8001/1:0:1:1:1:0:D7AC88:0:0:0:",
        plp = 0,
        pnr = 0,
        pid = 4095,
    })
    ...
    make_channel({
        name = "11403V SID 0x01",
        input = { "t2mi://t2mi_dasto_plp0", },
        output = { "http://0.0.0.0:9999/dasto_plp0", },
    })

t2mi_dasto_plp1= make_t2mi_decap({
        name = "11403V SID 0x01 PLP1",
        input = "http://127.0.0.1:8001/1:0:1:1:1:0:D7AC88:0:0:0:",
        plp = 1,
        pnr = 0,
        pid = 4095,
    ...
    make_channel({
        name = "11403V SID 0x01",
        input = { "t2mi://t2mi_dasto_plp1", },
        output = { "http://0.0.0.0:9999/dasto_plp1", },
    })

t2mi_dasto_plp2= make_t2mi_decap({
        name = "11403V SID 0x01 PLP2",
        input = "http://127.0.0.1:8001/1:0:1:1:1:0:D7AC88:0:0:0:",
        plp = 2,
        pnr = 0,
        pid = 4095,
    ...
    make_channel({
        name = "11403V SID 0x01",
        input = { "t2mi://t2mi_dasto_plp2", },
        output = { "http://0.0.0.0:9999/dasto_plp2", },
    })

t2mi_dasto_plp3= make_t2mi_decap({
        name = "11403V SID 0x01 PLP3",
        input = "http://127.0.0.1:8001/1:0:1:1:1:0:D7AC88:0:0:0:",
        plp = 3,
        pnr = 0,
        pid = 4095,
    ...
    make_channel({
        name = "11403V SID 0x01",
        input = { "t2mi://t2mi_dasto_plp3", },
        output = { "http://0.0.0.0:9999/dasto_plp3", },
    })

t2mi_dasto_plp4= make_t2mi_decap({
        name = "11403V SID 0x01 PLP4",
        input = "http://127.0.0.1:8001/1:0:1:1:1:0:D7AC88:0:0:0:",
        plp = 4,
        pnr = 0,
        pid = 4095,
    ...
    make_channel({
        name = "11403V SID 0x01",
        input = { "t2mi://t2mi_dasto_plp4", },
        output = { "http://0.0.0.0:9999/dasto_plp4", },
    })

t2mi_dasto_plp5= make_t2mi_decap({
        name = "11403V SID 0x01 PLP5",
        input = "http://127.0.0.1:8001/1:0:1:1:1:0:D7AC88:0:0:0:",
        plp = 5,
        pnr = 0,
        pid = 4095,
    ...
    make_channel({
        name = "11403V SID 0x01",
        input = { "t2mi://t2mi_dasto_plp5", },
        output = { "http://0.0.0.0:9999/dasto_plp5", },
    })

t2mi_dasto_plp6= make_t2mi_decap({
        name = "11403V SID 0x01 PLP6",
        input = "http://127.0.0.1:8001/1:0:1:1:1:0:D7AC88:0:0:0:",
        plp = 6,
        pnr = 0,
        pid = 4095,
    ...
    make_channel({
        name = "11403V SID 0x01",
        input = { "t2mi://t2mi_dasto_plp6", },
        output = { "http://0.0.0.0:9999/dasto_plp6", },
    })

t2mi_dasto_plp7= make_t2mi_decap({
        name = "11400V SID 0x01 PLP7",
        input = "http://127.0.0.1:8001/1:0:1:1:1:0:D7AC88:0:0:0:",
        plp = 7,
        pnr = 0,
        pid = 4095,
    ...
    make_channel({
        name = "11400V SID 0x01",
        input = { "t2mi://t2mi_dasto_plp7", },
        output = { "http://0.0.0.0:9999/dasto_plp7", },
    })

-- KRRT 12380 H 27500 4.8E 4096

krrt_12380_4096 = make_t2mi_decap({
        name = "MX",
        input = "http://127.0.0.1:8001/1:0:1:320:2:55:300000:0:0:0:",
        plp = 0,
        pnr = 0,
        pid = 4096,
    })
    ...
    make_channel({
        name = "MX",
        input = { "t2mi://krrt_12380_4096", },
        output = { "http://0.0.0.0:9999/krrt_4096", },
    })
    
-- KRRT 12380 H 27500 4.8E 4097

krrt_12380_4097 = make_t2mi_decap({
        name = "Service 801",
        input = "http://127.0.0.1:8001/1:0:1:321:2:55:300000:0:0:0:",
        plp = 0,
        pnr = 0,
        pid = 4097,
    })
